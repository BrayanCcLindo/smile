      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20">
          ...
          <div className="lg:w-1/2 w-full leading-relaxed text-gray-500 flex flex-col justify-center items-start gap-6">
            <p>
              Ideal para los momentos que necesitas apoyo de tu comunidad, como
              movimientos ciudadanos, proyectos personales, de animales o
              momentos difíciles cuando la unión hará la diferencia.
            </p>
